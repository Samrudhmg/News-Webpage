    ...
    render() {
        ...
        return (
            <div className='container' >
                <h1 className='text-center' style={{padding:'10px 10px'}}>News-top headlines</h1>
                ...
                <div className='row'>
                            ...
                            <div className='col-md-4'  key={element.url}>
                                <Newsitem imageurl={element.urlToImage}
                                    title={element.title ? element.title.slice(0, 45) : ""}
                                     data={element.description ? element.description.slice(0, 50) : ''} 
                    ...
                    <div className="container d-flex justify-content-between">
                        <button disabled={this.state.page<=1}className="btn btn-dark" onClick={this.handleonpre} type="button">&larr; previous</button>
                        <button disabled={( this.state.page + 1 > Math.ceil( this.state.totalResults/this.props.pagesize))} className="btn btn-dark" onClick={this.handleonnext} type="button">Next	&rarr;</button>
                    </div>
